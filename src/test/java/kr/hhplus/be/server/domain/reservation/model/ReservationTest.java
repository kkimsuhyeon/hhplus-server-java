...
class ReservationTest {
    ...
    @Test
    void isExpired_Test() {
        Reservation expiredReservation = Reservation.builder().expiresAt(LocalDateTime.now().minusMinutes(1)).build();
        Reservation validReservation = Reservation.builder().expiresAt(LocalDateTime.now().plusMinutes(1)).build();
