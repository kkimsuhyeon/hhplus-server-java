...
class UserTest {
    ...
    class AddBalanceTest {
        ...
        void addBalance_success() {
            User user = getTestUser(BigDecimal.ZERO);
    ...
    class DeductBalanceTest {
        ...
        void deductBalance_success1() {
            User user = getTestUser(BigDecimal.valueOf(1000));
    ...
    private User getTestUser(BigDecimal balance) {
        return User.of("", EMAIL, PASSWORD, balance, UserRole.USER);
    }
